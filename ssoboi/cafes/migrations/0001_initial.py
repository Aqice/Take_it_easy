# Generated by Django 2.1 on 2018-08-13 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(max_length=3500, verbose_name='Отзыв')),
                ('rating', models.FloatField(verbose_name='Рейтинг отзыва')),
                ('add_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата добавления')),
                ('author', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.User', verbose_name='Автор отзыва')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
